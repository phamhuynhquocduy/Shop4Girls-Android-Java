...
public class FaceAdapter extends RecyclerView.Adapter<FaceAdapter.ItemHolder> {
    public Context context;
    public ArrayList<Product> arrayList;

    public FaceAdapter(Context context, ArrayList<Product> arrayList) {
    ...
    @NonNull
    @Override
    public FaceAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_new_category_product,null);
        FaceAdapter.ItemHolder itemHolder=new FaceAdapter.ItemHolder(v);
        return itemHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull FaceAdapter.ItemHolder itemHolder, final int i) {
