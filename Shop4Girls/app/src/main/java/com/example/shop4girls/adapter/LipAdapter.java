...
public class LipAdapter  extends RecyclerView.Adapter<LipAdapter.ItemHolder> {
    public Context context;
    public ArrayList<Product> arrayList;

    public LipAdapter(Context context, ArrayList<Product> arrayList) {
    ...
    @NonNull
    @Override
    public LipAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_new_category_product,null);
        LipAdapter.ItemHolder itemHolder=new LipAdapter.ItemHolder(v);
        return itemHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull LipAdapter.ItemHolder itemHolder, final int i) {
