...
public class PerfumeAdapter extends RecyclerView.Adapter<PerfumeAdapter.ItemHolder> {
    public Context context;
    public ArrayList<Product> arrayList;

    public PerfumeAdapter(Context context, ArrayList<Product> arrayList) {
    ...
    @NonNull
    @Override
    public PerfumeAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_new_category_product, null);
        PerfumeAdapter.ItemHolder itemHolder = new PerfumeAdapter.ItemHolder(v);
        return itemHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull PerfumeAdapter.ItemHolder itemHolder, final int i) {
